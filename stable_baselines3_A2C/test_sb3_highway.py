...
model = A2C("MlpPolicy", env, n_steps=100, verbose=0, device=device)
model.learn(total_timesteps=10000, callback=ProgressBarCallback())
model.save("./stable_baselines3_A2C/a2c_custom_intersection")
...
model = A2C.load("./stable_baselines3_A2C/a2c_custom_intersection")
